...
mixin ProductsModel on ConnectedProductsModel {
  ...
  Future<bool> deleteProduct() {
    ...
    return http
        .delete(
            'https://flutter-course-13d4d.firebaseio.com/products/${deletedProductId}.json?auth=${_authenticatedUser.token}')
  ...
  Future<Map<String, dynamic>> authenticate(String email, String password,
    ...
    if (mode == AuthMode.Login) {
      response = await http.post(
        'https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyDvBZWmc2DfqLrcdAJttEnYz3R9T4ytQd0',
        body: json.encode(authData),
        headers: {'Content-Type': 'application/json'},
      );
    } else {
      response = await http.post(
        'https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyDvBZWmc2DfqLrcdAJttEnYz3R9T4ytQd0',
        body: json.encode(authData),
        headers: {'Content-Type': 'application/json'},
      );
    }
